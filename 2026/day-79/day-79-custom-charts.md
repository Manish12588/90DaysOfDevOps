...
keywords:
  ...
  - ai
```
**[Chart.yml](./Helm-Bankapp/Chart.yml)**
...
**[values.yaml](./Helm-Bankapp/values.yaml)**
...
Access the app:
```bash
kubectl port-forward svc/my-bankapp-service -n bankapp 9090:8080
```
Open `http://localhost:8080` -- you should see the AI-BankApp login page.

![](Images/Task-6_Step-.png)
