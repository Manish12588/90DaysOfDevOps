...
1. Why was Kubernetes created? What problem does it solve that Docker alone cannot?
   - Kubernetes created for scalling the app, Docker can run container but cannot manage them at scale.

2. Who created Kubernetes and what was it inspired by?
   - It was created by google and it's inspired by Borg, Which google was using to manage containers.
