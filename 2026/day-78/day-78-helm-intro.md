...
**Install Kind on EC2 server - Linux**
```bash
# For AMD64 / x86_64
...
```
![](Images/Task-3_Options-2_Step-1.png)
...
```
![](Images/Task-3_Options-2_Step-2.png)
...
```
![](Images/Task-3_Options-2_Step-3.png)

Verify MySQL is running:
```bash
kubectl exec -it pod/bankapp-mysql-849f6c989f-jz8j9 -- mysql -uroot -pTest@123 -e "SHOW DATABASES;"
```
You should see `bankappdb` in the output.

![](Images/Task-3_Options-2_Step-4.png)
...
```
**[mysql-values.yaml](./Created-files/mysql-values.yaml)**
...
```
**[mysql-values.yaml](./Created-files/mysql-values-1.yaml)**
